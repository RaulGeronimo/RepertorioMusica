...
class AlbumController {
    ...
    crear(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query("CALL crear_album(?)", [values]);
    ...
    actualizar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query("CALL actualizar_album(?,?)", [idAlbum, values]);
    ...
    eliminar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query("CALL eliminar_album(?,?)", [idAlbum, Usuario]);
